<template>
  <div class="container mx-auto p-4">
    <PageSeo title="全球PING" description="使用RIPE Atlas网络探针从全球各地对目标主机进行PING测试，分析网络延迟和可达性。" />
            ...
            <div class="flex flex-col md:flex-row gap-4 items-end">
              ...
              <div class="form-control flex-1">
                ...
                <div class="join w-full">
                  ...
                  <button class="btn btn-primary join-item w-24" @click="performPing" :disabled="!canQuery">
                          ...
                          <tr v-for="result in processedResults" :key="result.probe_id"
                            ...
                            <td>
                              <div class="flex flex-col">
                                ...
                                <span class="text-xs opacity-70">{{ result.min_rtt || '-' }} - {{ result.max_rtt || '-'
                                }}</span>
                              </div>
                            </td>
                            <td>
...
import { loadGeoIpDatabase, getIpGeoLocation, getApiKey, setApiKey } from '~/utils/geoip'
